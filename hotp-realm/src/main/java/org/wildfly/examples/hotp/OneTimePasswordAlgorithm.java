...
class OneTimePasswordAlgorithm {
    ...
    /**
     * Calculates the checksum using the credit card algorithm. This algorithm has the advantage that it detects any single
     * mistyped digit and any single transposition of adjacent digits.
     *
     ...
     *
     *
     * algorithm. HMAC computes a Hashed Message Authentication Code and in this case SHA1 is the hash algorithm used.
     *
     ...
     * @param truncationOffset the offset into the MAC result to begin truncation. If this value is out of the range of 0 ...
     *        15, then dynamic truncation will be used. Dynamic truncation is when the last 4 bits of the last byte of the MAC
