...
package org.wildfly.security.examples.same_virtual_domain.ejb;
...
import org.wildfly.security.examples.ejb_same_domain.ejb.WhoAmI;
...
public class EntryBean {
    ...
    @PermitAll
    public String invokeWhoAmIBean() {
        WhoAmI bean = lookup(WhoAmI.class, "java:global/same-virtual-domain/ejb-same-domain-ejb/WhoAmIBean!org.wildfly.security.examples.ejb_same_domain.ejb.WhoAmI");
        return bean.whoAmI();
    }
